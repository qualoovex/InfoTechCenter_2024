...
def gasLevelAlert():
    ...
    if gasLevel == "Empty":
        ...
        print("Your gas tank is EXTREMLY low, checking google maps for the closest gasstatio...")
        sleep (2.5)
        print("The closest gasstation is,",listOfGasSttations(),"which is",milesTGSLow,"miles away." )
